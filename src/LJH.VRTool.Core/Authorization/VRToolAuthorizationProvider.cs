...
namespace LJH.VRTool.Authorization
{
    public class VRToolAuthorizationProvider : AuthorizationProvider
    {
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            ///组织管理
            var organizations = basic.CreateChildPermission(PermissionNames.Pages_Organizations, L("Pages_Organizations"));
            ...
            logs.CreateChildPermission(PermissionNames.Pages_Logs_SearchAct, L("Pages_Logs_SearchAct"));
            logs.CreateChildPermission(PermissionNames.Pages_Logs_DetailAct, L("Pages_Logs_DetailAct"));
            logs.CreateChildPermission(PermissionNames.Pages_Logs_DeleteAct, L("Pages_Logs_DeleteAct"));
            logs.CreateChildPermission(PermissionNames.Pages_Logs_BatchDeleteAct, L("Pages_Logs_BatchDeleteAct"));
            ///网站设置
